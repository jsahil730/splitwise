...
import com.example.splitwise.transaction.DecimalDigitsInputFilter;
import com.example.splitwise.transaction.GetStakesTransaction;
...
public class AddTransactionGroup extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_transaction_group);
        ...
        group_id = getIntent().getStringExtra(getString(R.string.key_group_id));
        ...
        add_people.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CollectionReference groupRef = firestoreHelper.getGroupsRef().document(group_id)
                ...
                groupRef.get()
                        .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                            ...
                            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                ...
                                Intent intent = new Intent(AddTransactionGroup.this, SelectTransactionUsersGroup.class);
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception e) {
                                Toast.makeText(AddTransactionGroup.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        });
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuInflater.inflate(R.menu.menu_new_transac_group,menu);
        return true;
    }
        ...
        switch (item.getItemId()) {
            case R.id.next_button:
                ...
                if (amt_string.isEmpty()) {
                    ...
                    Intent intent = new Intent(AddTransactionGroup.this, GetStakesTransaction.class);
                    Bundle bundle = new Bundle();
                    ...
                    bundle.putString(getString(R.string.key_group_id),group_id);
                    intent.putExtras(bundle);
                    startActivity(intent);
                }
                return true;

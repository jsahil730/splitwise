...
public class SelectTransactionUsers extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuInflater.inflate(R.menu.menu_select_transactors,menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.finish_transactor_selection:
                ...
                Intent intent = new Intent(SelectTransactionUsers.this,AddTransaction.class);
